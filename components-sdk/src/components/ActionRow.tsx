...
import {ActionRowComponent, ActionRowPossible, ButtonComponent, ComponentType,} from '../utils/componentTypes';
...
function ActionRowInner(props: ComponentsProps & { state: ActionRowPossible, index: number }) {
    ...
    return <Component stateKey={stateKeyCached} passProps={props.passProps} stateManager={props.stateManager}
                      state={props.state} removeKeyParent={props.removeKeyParent}
