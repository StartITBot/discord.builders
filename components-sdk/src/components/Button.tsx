            ...
            {state.style === 5 ? (
                <>
                    <div className={CapsuleStyles.text + ' ' + Styles.link_btn}>
                        ...
                        <div className={Styles.link} style={{ width: textWidth }}>
                            {(state.url || '').replace('https://', '').replace('http://', '')}
                        </div>
                    </div>

                    <div style={{ paddingLeft: '10px' }}>
                        <i className="fas fa-arrow-up-right-from-square" style={{ fontSize: 12 }}></i>
                    </div>
                </>
            ) : (
