...
function GlobalSettings({
    ...
    return (
        <div
            className={Styles.select_option + ' ' + Styles.select_default + (open ? ' ' + Styles.open : '')}
            onClick={(ev) => {
        ...
        >
            ...
            <div className={Styles.with_badge}>
                ...
                <div className={Styles.badge}>
                    {state.min_values === state.max_values
                        ? state.min_values
                        : `${state.min_values} – ${state.max_values}`}
                </div>
            </div>
...
export function MenuRange({
    ...
    return (
        <div className={Styles.menu_range}>
            <Slider
                min={min}
                max={max}
                step={1}
                marks={Array.from({ length: max + 1 }, (_, i) => i)}
                value={state}
...
function GlobalSettingsFirst({
    ...
    return (
        <>
            <div
                className={CapsuleStyles.large_button_ctx_item}
                onClick={() => {
            ...
            >
                ...
                <div className={CapsuleStyles.large_button_ctx_item_text}>
                    {state.disabled ? 'Mark everything as enabled' : 'Mark everything as disabled'}
                </div>
            </div>
            ...
            >
                ...
                <div className={CapsuleStyles.large_button_ctx_item_text}>
                    Set number of maxiumum options to be selected
                </div>
            </div>
        </>
    );
...
function StringSelectOption({
    ...
    return (
        ...
        >
            {state.emoji !== null && (
                <div className={CapsuleStyles.emoji}>
    ...
    return (
        <>
            ...
            >
                ...
                <div className={CapsuleStyles.large_button_ctx_item_text}>
                    {state.disabled ? 'Mark as enabled' : 'Mark as disabled'}
                </div>
            </div>
            {!state.disabled && (
                <div
                ...
                >
                    ...
                    <div className={CapsuleStyles.large_button_ctx_item_text}>
                        {state.default ? 'Unselect this by default' : 'Select this by default'}
                    </div>
                </div>
            )}
            <div
