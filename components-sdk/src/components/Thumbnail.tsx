...
function MenuFirst({
    ...
    return (
        <>
            ...
            >
                <div className={CapsuleStyles.large_button_ctx_item_img}>
                    <img src={state.spoiler ? SpoilerActiveIcon : SpoilerIcon} alt="" />
                </div>
                <div className={CapsuleStyles.large_button_ctx_item_text}>
                    {state.spoiler ? 'Remove spoiler' : 'Set spoiler'}
                </div>
            </div>
            {!!removeKeyParent && (
                <div
            ...
            {!!removeKeyParent && (
                <div
                    className={CapsuleStyles.large_button_ctx_item + ' ' + CapsuleStyles.separator}
                    onClick={(ev) => {
                        setOpen(0);
