...
export function CapsuleButton({ context, callback, className }: props) {
    ...
    return (
        <div
            className={Styles.large_button + cls}
            onClick={(ev) => {
        ...
        >
            ...
            {open && (
                <div className={Styles.large_button_ctx} ref={btn_select}>
                    {['main', 'inline', 'container'].includes(context) && (
                        <div
                            className={Styles.large_button_ctx_item}
                            onClick={() => {
                                callback(default_settings.TextDisplay());
                            }}
                        >
                            <div className={Styles.large_button_ctx_item_img}>
                                <img src={TextDisplayIcon} alt="" />
                            </div>
                            <div className={Styles.large_button_ctx_item_text}>Content</div>
                        </div>
                    )}
                    {['main'].includes(context) && (
                        <div
                            className={Styles.large_button_ctx_item}
                            onClick={() => {
                    ...
                    {['main', 'container'].includes(context) && (
                        <div
                            className={Styles.large_button_ctx_item}
                            onClick={() => {
                    ...
                    {['main', 'frame', 'container', 'button-row'].includes(context) && (
                        <div
                            className={Styles.large_button_ctx_item}
                            onClick={() => {
                                callback(
                                    context === 'frame'
                                        ? default_settings.Button().components[0]
                    ...
                    {['main', 'frame', 'container', 'button-row'].includes(context) && (
                        <div
                            ...
                            onClick={() => {
                                callback(
                                    context === 'frame'
                                        ? default_settings.LinkButton().components[0]
                                        : default_settings.LinkButton()
                                );
                            }}
                        >
                            <div className={Styles.large_button_ctx_item_img}>
                                <img src={LinkButtonIcon} alt="" />
                            </div>
                            <div className={Styles.large_button_ctx_item_text}>Button link</div>
                        </div>
                    )}
                    {['main', 'container', 'container'].includes(context) && (
                        <div
                            className={Styles.large_button_ctx_item}
                            onClick={() => {
