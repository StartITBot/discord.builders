...
function App() {
    ...
    return <div className={Styles.app}>
        ...
        <div className={Styles.json}>
            ...
            <a href="https://github.com/StartITBot/discord.builders" target="_blank">
            ...
            <p style={{marginBottom: '0.5rem', marginTop: '4rem'}}><span style={{
                fontSize: 16,
                color: 'white',
                fontWeight: '500'
            }}>{t('webhook.title')}</span>{!showThread && <> (<span className={Styles.link}
                                                                    onClick={() => dispatch(actions.setShowThread())}>{t('webhook.thread')}</span>) </>}
            </p>
            ...
            {showThread && <div style={{marginBottom: '2rem'}}>
                ...
                <input className={Styles.input} type="text" value={threadId || ""}
                       onChange={ev => dispatch(actions.setThreadId(ev.target.value))}
            ...
            <dialog ref={dialog} className={Styles.dialog}>
                ...
                <div>
                    ...
                    <input className={Styles.input} autoFocus={true} type="text" value={postTitle}
                           onChange={ev => setPostTitle(ev.target.value)} placeholder={t('thread.post.placeholder')}/>
                </div>
                ...
                <div className={Styles.langs}>
                    {supportedLngs.map((lang) => (
                        <span key={lang} className={Styles.lang}
                              onClick={() => i18next.changeLanguage(lang)}>{lang}</span>
                    ))}
                </div>
